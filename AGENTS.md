...
This project is indexed by GitNexus as **ploke** (51185 symbols, 92330 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
