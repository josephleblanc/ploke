...
Invariant claim: the immutable/mutated/ambient commitment should be a static validation witness computed from Artifacts before candidate execution (`docs/workflow/evalnomicon/chat-history/history-blocks-v2.md:213`). Ordinary succession must disallow `ploke-eval` mutation, and the block should commit to the resulting surface (`docs/workflow/evalnomicon/drafts/history/crown-authority-background.md:86`, `docs/workflow/evalnomicon/drafts/history/crown-authority-background.md:91`).
