...
`references/prototype1-history-crown.md`. That reference explains why strict
transition gates are part of the self-editing safety model rather than ordinary
defensive checks.
