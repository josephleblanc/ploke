...
These are formal workflow skills captured in-repo.

Operational skills for `§X`:

- [cli-trace-review](cli-trace-review/SKILL.md)
- [bug-report-discipline](bug-report-discipline/SKILL.md)
...
- [pipeline-registry](pipeline-registry/SKILL.md)
...
- [doc-cleanup](doc-cleanup/SKILL.md)
- [evidence-ledger](evidence-ledger/SKILL.md)
- [failure-taxonomy](failure-taxonomy/SKILL.md)
- [lab-book](lab-book/SKILL.md)
