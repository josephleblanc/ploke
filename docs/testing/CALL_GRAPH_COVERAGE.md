...
| `corpus_axum_call_graph_2026-07-07.sqlite` | `github:tokio-rs/axum@a3446d68bc03d61fb8e7513052bad2825d0c0db1` | Main real-corpus DB/RAG/TUI call graph matrix | Covers functions, methods, imports, re-exports, generated frontiers, proc macros, trait bodies, local items, proof facts, and usage questions. |
| `corpus_chrono_call_graph_2026-07-07.sqlite` | `github:chronotope/chrono@120686c82c5da90377e815edb82c9a80b6b4f2be` | Alias constructors, try receivers, external slice receiver frontiers | Covered by real-corpus fallback tests. |
| `corpus_memchr_call_graph_2026-07-07.sqlite` | `github:BurntSushi/memchr@24f5daa5257e00e87007c936761600e034827905` | Dynamic field/function-pointer fallback rows and callable trait-object blockers | Covered by fallback DB/RAG/TUI targetless tests. |
| `corpus_generic_array_call_graph_2026-07-07.sqlite` | `github:fizyk20/generic-array@80bab87431c2e29823dc551a3311324812838a23` | Guarded match-arm fallback receiver rows | Covered by DB fallback tests. |
