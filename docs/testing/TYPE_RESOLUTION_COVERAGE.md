...
Resolution path: always-on v2 typed type graph
...
The legacy late type-use resolver surface and its `type_use_resolution.rs` test
file were removed when v2 became the single transform path.
