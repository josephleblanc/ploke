...
- [backup-dbs_progress-2026-03-20-ploke-db-loader-survey.md](/home/brasides/code/ploke/docs/active/agents/backup-dbs_progress-2026-03-20-ploke-db-loader-survey.md)
- [ploke-rag-backup-loading-survey-2026-03-20.md](/home/brasides/code/ploke/docs/active/agents/ploke-rag-backup-loading-survey-2026-03-20.md)
- [backup-dbs_ploke-tui-loading-survey_2026-03-20.md](/home/brasides/code/ploke/docs/active/agents/backup-dbs_ploke-tui-loading-survey_2026-03-20.md)
...
- `ploke-tui`
  ...
  - current consumers:
    - [crates/ploke-tui/tests/overlay_fixture_tests.rs](/home/brasides/code/ploke/crates/ploke-tui/tests/overlay_fixture_tests.rs)
    - [crates/ploke-tui/tests/overlay_manager_smoke.rs](/home/brasides/code/ploke/crates/ploke-tui/tests/overlay_manager_smoke.rs)

Deferred for now:

- `ploke-db` mutable/per-test loaders and the documented unit-test exception
- `ploke-tui` live-tool scaffolding in
  [crates/ploke-tui/src/app/commands/exec_real_tools_live_tests.rs](/home/brasides/code/ploke/crates/ploke-tui/src/app/commands/exec_real_tools_live_tests.rs)
