...
| Test planning | Impact test/non-test buckets, source metadata, admitted generated test-harness entrypoint summaries, typed `call_test_entrypoints`, and DB `call_test_selection_for_target` identify stored source-test callers, resolved source-test paths, proof-only generated entrypoints, and linked build-domain proof metadata for a changed target. | Partial: generated harness summaries remain proof facts, no generated harness source edge is fabricated, and CI policy selection is not modeled. |
