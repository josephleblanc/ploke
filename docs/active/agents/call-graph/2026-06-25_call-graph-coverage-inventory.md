...
| Structural extraction | Partial | Path calls, method calls, dynamic/non-path calls, macro calls, const/static initializer calls, associated const initializer calls, closure/async block bodies, and selected function-local item bodies are extracted for the covered fixtures. Closure/async/local-item inner calls are attributed to typed executable owners, not to enclosing function owners. | Desugared/implicit calls, macro expansion, build-script generated code, arbitrary generated owners, and broader async poll/resume effect modeling. |
