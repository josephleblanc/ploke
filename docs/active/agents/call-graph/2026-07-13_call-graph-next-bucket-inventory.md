...
- The latest committed callable-field slice regenerates the active axum fixture
  ...
  blockers.
- The latest returned future field producer slice is surfaced through DB and
  exact RAG for `axum/src/error_handling/mod.rs:134-148`
  ...
  Exact TUI lookup/edges do not yet have a body/signature disambiguator for the
  hand-written `HandleError::call` owner among the generated same-name impls,
  so no TUI assertion was added for this specific owner.
