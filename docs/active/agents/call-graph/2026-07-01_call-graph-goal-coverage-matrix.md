...
Reason to stay in this bucket: add only the matching downstream RAG/TUI
propagation proof for this exact DB-positive shape, then switch buckets unless
the matrix identifies one adjacent callable-parameter source oracle.
