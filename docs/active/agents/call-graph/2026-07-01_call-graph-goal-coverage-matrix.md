...
- Follow-up coverage keeps the chrono guarded `self.queue.is_empty()`
  ...
  `parse_next_item` body; the generic shared RAG adapter also intentionally
  exercises bounded owner collection, which truncates this late callsite.
