...
- [`2026-06-16_prototype1-state-walk-server.md`](2026-06-16_prototype1-state-walk-server.md) — cold-restart orientation for the debug-only local typestate walk server, including commands, module map, Zellij-inspired lifecycle choices, guardrails, known sharp edges, and next slices.
- [`2026-06-17_prototype1-state-walk-command-guide.md`](2026-06-17_prototype1-state-walk-command-guide.md) — short operator guide for trying the `prototype1-state-walk` commands, including status/start/step/show/files/reset/stop examples and feedback prompts.
