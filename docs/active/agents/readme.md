...
- [`2026-07-13_prototype1-loop-operator-control-plan.md`](2026-07-13_prototype1-loop-operator-control-plan.md) — proposed restart spine for configuration validation, single-controller UI/CLI operation, R-state observability, replay/branching, successor handoff, and domain-preserving database migration.
