...
- [`2026-06-02_prototype1-state-loop-walkthrough.md`](2026-06-02_prototype1-state-loop-walkthrough.md) — detailed implementation walkthrough for `ploke-eval loop prototype1-state`: config planes, parent/child execution path, disk writes, persisted DTOs, live model/API routing, and parallelism opportunities.
- [`2026-06-02_prototype1-state-terminology-conflicts.md`](2026-06-02_prototype1-state-terminology-conflicts.md) — companion terminology audit for the Prototype 1 state-loop walkthrough, tracking overloaded terms, draft conventions, and open questions for follow-up.
