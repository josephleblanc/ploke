...
- [`2026-05-15_hyperagents-context-building-handoff.md`](2026-05-15_hyperagents-context-building-handoff.md) — restart note for the clean live broad-harness splice and the prompt/RAG lesson: broad edit posture is intentional, but automatic source-code context injection can steer the model without explicit evaluation analysis.
