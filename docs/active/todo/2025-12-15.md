...
- [ ] Add overlay for embedding model selection
  - [x] basic overlay functionality
    ...
    - [x] items expand/collapse upon `l`/`h` and right/left arrow with more details at different levels of verbosity
      - [x] initial expansion includes price, context window, truncated description
      - [x] full expansion includes all fields available
      - [ ] debug: the truncated version of the description is shown in both the initial expansion and full expansion
