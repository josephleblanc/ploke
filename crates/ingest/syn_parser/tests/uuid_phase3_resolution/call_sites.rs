...
const MAKE_ALIAS_BOUND_CLOSURE_INNER_CALL_SPAN: (usize, usize) = (32823, 32849);
const MAKE_ALIAS_BOUND_CLOSURE_RETURNED_CLOSURE_SPAN: (usize, usize) = (32722, 32727);
const RETURNED_ALIAS_BOUND_CLOSURE_DYNAMIC_CALL_SPAN: (usize, usize) = (32823, 32851);
...
const TUPLE_PATTERN_LOCAL_INSTANCE_CALL_SPAN: (usize, usize) = (34328, 34350);
const TYPED_TUPLE_PATTERN_LOCAL_INIT_CALL_SPAN: (usize, usize) = (34536, 34559);
const TYPED_TUPLE_PATTERN_LOCAL_INSTANCE_CALL_SPAN: (usize, usize) = (34565, 34587);
...
const BORROWED_VALUE_PARAM_INSTANCE_CALL_SPAN: (usize, usize) = (35063, 35088);
const BORROWED_VALUE_PARAM_METHOD_RESULT_INSTANCE_CALL_SPAN: (usize, usize) = (35187, 35226);
...
const SINGLE_FUNCTION_POINTER_PARAM_CALL_SPAN: (usize, usize) = (32922, 32925);
const SINGLE_FUNCTION_POINTER_CALLER_SPAN: (usize, usize) = (33004, 33052);
const SINGLE_GENERIC_FN_ONCE_PARAM_CALL_SPAN: (usize, usize) = (33153, 33164);
const SINGLE_GENERIC_FN_ONCE_CALLER_SPAN: (usize, usize) = (33242, 33289);
const SINGLE_PARENTHESIZED_FUNCTION_POINTER_PARAM_CALL_SPAN: (usize, usize) = (33374, 33379);
const SINGLE_PARENTHESIZED_FUNCTION_POINTER_CALLER_SPAN: (usize, usize) = (33472, 33534);
const SINGLE_FUNCTION_POINTER_PARAM_CAST_CALL_SPAN: (usize, usize) = (34663, 34683);
const SINGLE_FUNCTION_POINTER_PARAM_CAST_CALLER_SPAN: (usize, usize) = (34767, 34820);
const SINGLE_INDEXED_FIELD_FUNCTION_PARAM_CALL_SPAN: (usize, usize) = (33733, 33754);
const SINGLE_INDEXED_FIELD_FUNCTION_CALLER_SPAN: (usize, usize) = (33839, 33930);
const SINGLE_INDEXED_TUPLE_FIELD_FUNCTION_PARAM_CALL_SPAN: (usize, usize) = (34031, 34044);
const SINGLE_INDEXED_TUPLE_FIELD_FUNCTION_CALLER_SPAN: (usize, usize) = (34135, 34223);
...
const SELF_FIELD_RESULT_ASSOC_OWNER_IMPL_SPAN: (usize, usize) = (31012, 31169);
const SELF_FIELD_METHOD_RESULT_INSTANCE_CALL_SPAN: (usize, usize) = (31120, 31161);
...
const INHERITED_GLOB_REEXPORTED_TYPE_ASSOC_MAKE_CALL_SPAN: (usize, usize) = (30969, 30992);
