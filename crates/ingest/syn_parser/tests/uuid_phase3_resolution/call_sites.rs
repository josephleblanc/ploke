...
const RETURNED_FORWARDED_FUNCTION_POINTER_INNER_CALL_SPAN: (usize, usize) = (49755, 49802);
const RETURNED_FORWARDED_FUNCTION_POINTER_DYNAMIC_CALL_SPAN: (usize, usize) = (49755, 49804);
const RETURNED_CONFLICTING_FUNCTION_POINTER_LOCAL_INNER_CALL_SPAN: (usize, usize) = (49998, 50057);
...
const MUT_REFERENCED_DYN_FNMUT_DYNAMIC_CALL_SPAN: (usize, usize) = (50675, 50692);
...
const BORROWED_PARAM_ALIAS_INSTANCE_CALL_SPAN: (usize, usize) = (55619, 55641);
...
const BORROWED_VALUE_PARAM_INSTANCE_CALL_SPAN: (usize, usize) = (35206, 35231);
const BORROWED_VALUE_PARAM_METHOD_RESULT_INSTANCE_CALL_SPAN: (usize, usize) = (35330, 35369);
...
const FORWARDED_FUNCTION_POINTER_LEAF_CALL_SPAN: (usize, usize) = (44614, 44617);
const FORWARDED_FUNCTION_POINTER_WRAPPER_CALL_SPAN: (usize, usize) = (44693, 44732);
const FORWARDED_FUNCTION_POINTER_PUBLIC_CALLER_SPAN: (usize, usize) = (44814, 44867);
const FORWARDED_CONFLICTING_FUNCTION_POINTER_LEAF_CALL_SPAN: (usize, usize) = (44952, 44955);
...
const FORWARDED_BOXED_DYN_FN_LEAF_CALL_SPAN: (usize, usize) = (53228, 53231);
const TWO_HOP_FORWARDED_BOXED_DYN_FN_LEAF_CALL_SPAN: (usize, usize) = (53564, 53567);
const FORWARDED_CONFLICTING_BOXED_DYN_FN_LEAF_CALL_SPAN: (usize, usize) = (54069, 54072);
const TWO_HOP_FORWARDED_FUNCTION_POINTER_LEAF_CALL_SPAN: (usize, usize) = (46504, 46507);
const TWO_HOP_FORWARDED_FUNCTION_POINTER_MIDDLE_CALL_SPAN: (usize, usize) = (46590, 46637);
const TWO_HOP_FORWARDED_FUNCTION_POINTER_WRAPPER_CALL_SPAN: (usize, usize) = (46721, 46770);
const TWO_HOP_FORWARDED_FUNCTION_POINTER_PUBLIC_CALLER_SPAN: (usize, usize) = (46860, 46921);
...
const TWO_HOP_FORWARDED_CONFLICTING_FUNCTION_POINTER_OTHER_CALLER_SPAN: (usize, usize) =
    (47605, 47678);
const TWO_HOP_FORWARDED_NAMED_FIELD_LEAF_CALL_SPAN: (usize, usize) = (47762, 47781);
const TWO_HOP_FORWARDED_NAMED_FIELD_MIDDLE_CALL_SPAN: (usize, usize) = (47867, 47914);
const TWO_HOP_FORWARDED_NAMED_FIELD_WRAPPER_CALL_SPAN: (usize, usize) = (48001, 48050);
const TWO_HOP_FORWARDED_NAMED_FIELD_PUBLIC_CALLER_SPAN: (usize, usize) = (48135, 48233);
const TWO_HOP_FORWARDED_CONFLICTING_NAMED_FIELD_LEAF_CALL_SPAN: (usize, usize) = (48329, 48348);
const TWO_HOP_FORWARDED_CONFLICTING_NAMED_FIELD_MIDDLE_CALL_SPAN: (usize, usize) = (48446, 48505);
const TWO_HOP_FORWARDED_CONFLICTING_NAMED_FIELD_WRAPPER_CALL_SPAN: (usize, usize) = (48604, 48665);
const TWO_HOP_FORWARDED_CONFLICTING_NAMED_FIELD_LOCAL_CALLER_SPAN: (usize, usize) = (48762, 48872);
const TWO_HOP_FORWARDED_CONFLICTING_NAMED_FIELD_OTHER_CALLER_SPAN: (usize, usize) = (48969, 49079);
...
const SINGLE_REFERENCED_DYN_FN_PARAM_CALL_SPAN: (usize, usize) = (51019, 51022);
const SINGLE_REFERENCED_DYN_FN_CALLER_SPAN: (usize, usize) = (51102, 51152);
const SINGLE_PARENTHESIZED_REFERENCED_DYN_FN_PARAM_CALL_SPAN: (usize, usize) = (51243, 51248);
const SINGLE_PARENTHESIZED_REFERENCED_DYN_FN_CALLER_SPAN: (usize, usize) = (51342, 51406);
const SINGLE_BOXED_DYN_FN_PARAM_CALL_SPAN: (usize, usize) = (51482, 51485);
const SINGLE_BOXED_DYN_FN_CALLER_SPAN: (usize, usize) = (51560, 51614);
const SINGLE_PARENTHESIZED_BOXED_DYN_FN_PARAM_CALL_SPAN: (usize, usize) = (51704, 51709);
const SINGLE_PARENTHESIZED_BOXED_DYN_FN_CALLER_SPAN: (usize, usize) = (51798, 51866);
...
const AWAITED_ASYNC_CLOSURE_FUTURE_ALIAS_BODY_LOCAL_TARGET_CALL_SPAN: (usize, usize) =
    (38900, 38914);
const AWAITED_ASYNC_CLOSURE_FUTURE_BLOCK_ALIAS_CALL_SPAN: (usize, usize) = (41554, 41563);
...
const AWAIT_METHOD_RESULT_INSTANCE_CALL_SPAN: (usize, usize) = (49542, 49585);
