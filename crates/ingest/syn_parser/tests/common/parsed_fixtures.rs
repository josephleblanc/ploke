...
use std::vec::Vec;
use crate::common::run_phases_and_collect; // Assuming run_phases_and_collect is in common::uuid_ids_utils or similar
...
lazy_static! {
    ...
    pub static ref PARSED_FIXTURE_CRATE_DIR_DETECTION: Vec<ParsedCodeGraph> =
        run_phases_and_collect("fixture_crate_dir_detection");
}
