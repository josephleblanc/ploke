...
mod tests {
    ...
    fn test_full_graph_generation_and_serialization() {
        ...
        assert!(!code_graph.defined_types.is_empty(), "No defined types found");
    ...
    fn test_concurrent_dashmap_access() {
        ...
        for i in 0..NUM_THREADS {
            ...
            let handle = thread::spawn(move || {
                ...
                assert!(!graph_clone.functions.is_empty(), "Thread {} found empty functions", i);
                assert!(!graph_clone.type_graph.is_empty(), "Thread {} found empty types", i);
            });
