...
// Primary Nodes
impl From<FunctionNodeId> for AnyNodeId { #[inline] fn from(id: FunctionNodeId) -> Self { AnyNodeId::Function(id) } }
impl From<StructNodeId> for AnyNodeId { #[inline] fn from(id: StructNodeId) -> Self { AnyNodeId::Struct(id) } }
impl From<EnumNodeId> for AnyNodeId { #[inline] fn from(id: EnumNodeId) -> Self { AnyNodeId::Enum(id) } }
impl From<UnionNodeId> for AnyNodeId { #[inline] fn from(id: UnionNodeId) -> Self { AnyNodeId::Union(id) } }
impl From<TypeAliasNodeId> for AnyNodeId { #[inline] fn from(id: TypeAliasNodeId) -> Self { AnyNodeId::TypeAlias(id) } }
impl From<TraitNodeId> for AnyNodeId { #[inline] fn from(id: TraitNodeId) -> Self { AnyNodeId::Trait(id) } }
impl From<ImplNodeId> for AnyNodeId { #[inline] fn from(id: ImplNodeId) -> Self { AnyNodeId::Impl(id) } }
impl From<ConstNodeId> for AnyNodeId { #[inline] fn from(id: ConstNodeId) -> Self { AnyNodeId::Const(id) } }
impl From<StaticNodeId> for AnyNodeId { #[inline] fn from(id: StaticNodeId) -> Self { AnyNodeId::Static(id) } }
impl From<MacroNodeId> for AnyNodeId { #[inline] fn from(id: MacroNodeId) -> Self { AnyNodeId::Macro(id) } }
impl From<ImportNodeId> for AnyNodeId { #[inline] fn from(id: ImportNodeId) -> Self { AnyNodeId::Import(id) } }
impl From<ModuleNodeId> for AnyNodeId { #[inline] fn from(id: ModuleNodeId) -> Self { AnyNodeId::Module(id) } }
// Associated Items
impl From<MethodNodeId> for AnyNodeId { #[inline] fn from(id: MethodNodeId) -> Self { AnyNodeId::Method(id) } }
// Secondary Nodes
impl From<FieldNodeId> for AnyNodeId { #[inline] fn from(id: FieldNodeId) -> Self { AnyNodeId::Field(id) } }
impl From<VariantNodeId> for AnyNodeId { #[inline] fn from(id: VariantNodeId) -> Self { AnyNodeId::Variant(id) } }
impl From<ParamNodeId> for AnyNodeId { #[inline] fn from(id: ParamNodeId) -> Self { AnyNodeId::Param(id) } }
impl From<GenericParamNodeId> for AnyNodeId { #[inline] fn from(id: GenericParamNodeId) -> Self { AnyNodeId::GenericParam(id) } }
// Other IDs
impl From<ReexportNodeId> for AnyNodeId { #[inline] fn from(id: ReexportNodeId) -> Self { AnyNodeId::Reexport(id) } }
