...
fn expand_simple_workspace_member(workspace_root: &Path, member_path: &Path) -> Vec<PathBuf> {
    ...
    // Minimal wildcard handling for workspace members such as "axum-*" or "crates/*".
