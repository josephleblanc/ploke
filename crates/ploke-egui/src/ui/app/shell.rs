...
use crate::ui::inspector::{
    ArtifactSourceSlot, InspectorSections, PatchInspection, RunRecordInspection, RunRecordSlot,
    RunRecordTurnInspection, SelectionEdge, SourceRef, UnavailableReason,
