...
pub struct WidthBudget {
    ...
    pub right_inspector_width_logical_px: u32,
    pub right_inspector_max_width_logical_px: u32,
...
impl WidthBudget {
    fn current_default() -> Self {
        ...
        let right_inspector_width = logical_px(app_layout::RIGHT_INSPECTOR_WIDTH);
        let right_inspector_max_width = logical_px(app_layout::RIGHT_INSPECTOR_MAX_WIDTH);
        let center_canvas_width = logical_px(app_layout::DEFAULT_CENTER_CANVAS_WIDTH);
        let min_center_canvas_width = default_window_width
            .saturating_sub(left_sidebar_max_width)
            .saturating_sub(right_inspector_max_width);
        ...
        Self {
            ...
            right_inspector_width_logical_px: right_inspector_width,
            right_inspector_max_width_logical_px: right_inspector_max_width,
    ...
    pub fn center_canvas_satisfies_minimum(&self) -> bool {
        percent(
            ...
            && self.center_canvas_width_logical_px > self.left_sidebar_width_logical_px
            && self.center_canvas_width_logical_px > self.right_inspector_width_logical_px
    }
}
