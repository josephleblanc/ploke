            ...
            match graph_from_run_root(&entry.path) {
                Ok(graph) => {
                    ...
                    entries.push(ArtifactConnectivityEntry {
                        ...
                        produced_child_edges: edges.produced_child_edges,
                        opened_from_edges: edges.opened_from_edges,
...
impl ArtifactConnectivityBatch {
    pub fn render_text(&self) -> String {
        ...
        for entry in &self.entries {
            let _ = writeln!(
                out,
                "- [{}] {}: A={}, P_H={}, P_C={}, P_O={}, P_B={}, weak={}, roots={}, orphan_artifacts={}, weakly_connected={}",
                entry.index,
                entry.name,
                entry.artifacts,
                entry.history_patches,
                entry.produced_child_edges,
                entry.opened_from_edges,
