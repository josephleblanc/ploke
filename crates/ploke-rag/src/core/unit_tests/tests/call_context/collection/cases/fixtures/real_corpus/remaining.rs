...
async fn call_context_exact_reads_remaining_axum_supported_matrix_targets() -> Result<(), Error> {
    ...
    let cases = vec![
        ...
        ExactShapeCase {
            ...
            // `T::from_request(...)`; handler/mod.rs:250 and
            // extract/tuple.rs:57 generated `Tn::from_request(...)` rows
            // resolve through generated bounds.
        ...
        ExactShapeCase {
            ...
            // error_handling/mod.rs, and extract/tuple.rs generated
            // `Tn::from_request_parts(...)` rows resolve through generated
            // bounds; extract/mod.rs:103 calls `Self::...` from an
            // async-block owner.
        ...
        ExactShapeCase {
            ...
            // rows, plus the axum-core request_parts workspace dependency
            // glob import.
