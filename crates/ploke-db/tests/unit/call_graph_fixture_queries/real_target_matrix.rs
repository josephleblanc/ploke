...
//! | Receiver forwarding gaps | `axum/src/extension.rs:180`, `routing/route.rs:51`, and `middleware/from_fn.rs:411` exercise field/result receivers | unsupported receiver shapes remain visible and targetless; `Router::new` currently has 143 caller rows and 122 incoming expansion candidates. |
