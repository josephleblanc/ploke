...
//! | High-fanout test helper | `axum/src/test_helpers/test_client.rs:36` defines `TestClient::new`; the oracle lists selected-member callsites | 167 structural `TestClient::new` rows are projected by module and file fanout; 105 traverse through nested/direct re-export imports and 62 remain unsupported and targetless. |
