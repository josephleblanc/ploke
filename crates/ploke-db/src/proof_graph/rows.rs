...
pub(super) struct ProofFactRow {
    ...
    pub(super) cfg_domain_id: Option<String>,
    pub(super) active_cfg_hash: Option<String>,
    pub(super) invocation_id: Option<String>,
    pub(super) rustc_program: Option<String>,
    pub(super) working_directory: Option<String>,
    pub(super) argument_vector_hash: Option<String>,
...
impl ProofFactRow {
    pub(super) fn from_data_values(row: &[DataValue]) -> Result<Self, DbError> {
        ...
        Ok(Self {
            ...
            cfg_domain_id: json.and_then(|value| json_string(value, "cfg_domain_id")),
            active_cfg_hash: json.and_then(|value| json_string(value, "active_cfg_hash")),
            invocation_id: json.and_then(|value| json_string(value, "invocation_id")),
            rustc_program: json.and_then(|value| json_string(value, "rustc_program")),
            working_directory: json.and_then(|value| json_string(value, "working_directory")),
            argument_vector_hash: json.and_then(|value| json_string(value, "argument_vector_hash")),
            environment_hash: json.and_then(|value| json_string(value, "environment_hash")),
            effect_seed_id: json.and_then(|value| json_string(value, "effect_seed_id")),
    ...
    pub(super) fn matches_query(&self, query: &str) -> bool {
        ...
        let scalar_match = [
            ...
            self.cfg_domain_id.as_deref(),
            self.active_cfg_hash.as_deref(),
            self.invocation_id.as_deref(),
            self.rustc_program.as_deref(),
            self.working_directory.as_deref(),
            self.argument_vector_hash.as_deref(),
            self.environment_hash.as_deref(),
            self.effect_seed_id.as_deref(),
