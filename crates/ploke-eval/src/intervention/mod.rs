...
pub use branch_registry::{
    ...
    active_branch_selection_for_target, branch_log, load_or_default_branch_registry,
    mark_treatment_branch_applied, prototype1_branch_registry_path, record_synthesized_branches,
    resolve_treatment_branch, resolved_treatment_branches_from_synthesis, restore_treatment_branch,
...
pub use scheduler::{
    BaselineInstance, CompleteBaseline, PROTOTYPE1_SCHEDULER_SCHEMA_VERSION,
    PROTOTYPE1_TREATMENT_NODE_SCHEMA_VERSION, Prototype1ChildBudget, Prototype1ChildScheduleMode,
