# Prototype 1 record inventory for diagram small multiples
...
## Known visual/layout decision

Do not draw every row as a node in the overview. Use this table for completeness and the small diagrams for local causality.
