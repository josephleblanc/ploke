...
| `src/cli/prototype1_state/history.rs` | History block model and filesystem `FsBlockStore`. |
...
| `src/cli/prototype1_state/backend.rs` | Workspace backend, currently git worktree based. |
