...
pub use manager::{
    ...
    ProviderAttemptTimeline, ProviderFailurePhase, ProviderResponseOutcome, ProviderRetryDecision,
    RecordedResponse, RecordedResponseTape, RequestMessage, ResponseIndex, chat_step,
