...
// Leaving LlmEvent in ploke-tui for now.
// I moved it here at first, but then decided this is really more about interfacing with the
// ploke-tui application than it is about managing the exchanges with the API providers over
// network.
// Leaving it commented out here just in case, delete after a week at most.
// #[derive(Clone, Debug)]
// pub enum LlmEvent {
