...
pub use proof_fact_fixtures::{
    ...
    axum_body_empty_dependency_record, axum_dependency_record, axum_dyn_future_poll_blocker,
    ...
    fixture_extern_c_abs_effect_record, generic_array_size_hint_guard_blocker,
};
