...
pub use proof_fact_fixtures::{
    ...
    axum_body_size_hint_summary_records, axum_call_graph_domain_records,
    axum_callback_parameter_blocker, axum_dependency_record, axum_dyn_future_poll_blocker,
    axum_entrypoint_effect_policy_record, axum_entrypoint_record,
