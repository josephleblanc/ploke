use crate::llm2::types::model_types::serialize_model_id_as_request_string;
...
impl ChatCompReqCore {
    ...
    pub(crate) fn with_model_str(self, model_str: &str) -> Result<Self, crate::llm2::IdError> {
...
mod tests {
    use crate::llm2::{manager::RequestMessage, request::JsonObjMarker, ModelId};
