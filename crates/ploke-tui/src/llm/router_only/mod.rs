...
pub(crate) use cli::{
    COMPLETION_JSON_SIMPLE_DIR, ENDPOINTS_JSON_DIR, MODELS_JSON_ARCH, MODELS_JSON_ID_NOT_NAME,
    MODELS_JSON_PRICING, MODELS_JSON_RAW, MODELS_TXT_IDS,
};

use crate::llm::manager::RequestMessage;
use crate::llm::manager::Role;
    ...
    R::CompletionFields: ApiRoute + Serialize,
{
    ...
    pub(crate) fn with_router_bundle(mut self, router: R::CompletionFields) -> Self {
        self.router = router;
        self
    }
    ...
    pub fn with_model_str(self, model_str: &str) -> Result<Self, crate::llm::IdError> {
