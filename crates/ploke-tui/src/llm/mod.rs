...
pub use manager::{
    ...
    ChatDebugToolResult, RequestTapGuard, ResponseTapGuard, clear_chat_debug_sink,
    clear_prototype1_trace_context_for_test, clear_recorded_response_tape, clear_request_tap,
    ...
    install_request_tap, install_response_tap, prototype1_trace_context_for_test,
    run_chat_debug_messages,
};
pub use manager::{
