...
// Simple public item
pub fn glob_public_item() -> u8 {
    40
}

// Crate-visible item (should NOT be re-exported by glob)
pub(crate) fn glob_crate_item() -> u8 {
    41
}
...
pub fn glob_item_cfg_a() -> u8 {
    42
}

#[cfg(not(feature = "glob_feat_a"))]
pub fn glob_item_cfg_not_a() -> u8 {
    43
}
...
pub mod pub_sub_with_restricted {
    ...
    pub(super) fn super_visible_item() -> u8 {
        45
    }

    // This is public within this module
    pub fn public_item_here() -> u8 {
        46
    }
}
